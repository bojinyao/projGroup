...
graph_file_path = './inputs/tiny/graph.gml'
constraints_path = './inputs/tiny/parameters.txt'

k = 8       # num of buses
s = 7       # capacity of each bus
N = 20      # total num of students
p_edge = 0.6    # probability of creating an edge in random graph  
constraint_limit = 100  # upper limit on number of constraints
