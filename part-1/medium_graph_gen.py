...
graph_file_path = './inputs/medium/graph.gml'
constraints_path = './inputs/medium/parameters.txt'

k = 22       # num of buses
s = 23       # capacity of each bus
N = 500      # total num of students
p_edge = 0.6    # probability of creating an edge in random graph  
constraint_limit = 1000  # upper limit on number of constraints
